         ...
         <ul>
            ...
            <ul>
               <li>
                  ...
                  being the same thing copied repeatedly, and notes being properly timed
               </li>
               <li>
                  You may not pick pending or graveyard maps which you mapped yourself (Loved, etc
                  are subject to regular conditions as above)
               </li>
               <li>Maps must have been submitted before the start of registrations</li>
            </ul>
            <li>Different difficulties of the same set may be used in the same pool</li>
            <ul>
               <li>
